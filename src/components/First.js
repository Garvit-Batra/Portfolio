...
function First() {
  ...
  return (
    <div
      data-aos="fade-right"
      style={{ marginTop: "3%", marginBottom: "5%", verticalAlign: "middle" }}
    >
      <div
        style={{
      ...
      >
        <div>
          ...
          <h2 className="writing-text heading">Computer Science Engineer</h2>
        </div>
        <div>
          <a
          ...
          <a href="mailto:batra.garvit28@gmail.com" class="fa fa-envelope"></a>
        </div>
      </div>
      <img
        style={{
